...
- Also was trying to use redis for contextual memory(which was used locally coz college blocked redis cloud.Im not able to use in college wifi so).Plus I'm not able to use it for contextual memory.